...
I plan to keep improving and working on it as much as I can for now I just wanted to see what I was capableof thanks for taking the time to check it out.

the webstie:
http://5ulliv4n.github.io/ControllerFinder/

Its able to find your contorller just plug it in or run it through bluetooth, and youre good to go.

The css code is suppose to look like the windows blue screen btw.
